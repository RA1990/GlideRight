  ...
  return (
    ...
    <React.Fragment>
      <footer className=" mt-5 pt-4 foot page-footer font-small pt-4 navbar-dark bg-dark">
        <div className="container">
          <ul className="list-unstyled list-inline text-center">
            <li className="list-inline-item">
              <a href="http://www.rauljaureguicodes.com" className="btn-floating">
                <i className="fa fa-rocket color m-2"> </i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/raul-jauregui/" className="btn-floating">
                <i className="fa fa-linkedin color  m-2"> </i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://github.com/RA1990" className="btn-floating">
        ...
        <div className="footer-copyright text-center py-3 copy"><a className="color" href="http://www.rauljaureguicodes.com"><i className="color">© 2019 Copyright:rauljaureguicodes.com</i></a>
        </div>
